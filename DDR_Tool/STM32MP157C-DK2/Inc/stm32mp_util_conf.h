...
#define UTIL_UART_INSTANCE        UTIL_UART7
#define UTIL_UART_TX_PIN          GPIO_PIN_7
#define UTIL_UART_TX_GPIO_PORT    UTIL_GPIOF
#define UTIL_UART_TX_AF           GPIO_AF7_UART7
#define UTIL_UART_RX_PIN          GPIO_PIN_6
#define UTIL_UART_RX_GPIO_PORT    UTIL_GPIOF
#define UTIL_UART_RX_AF           GPIO_AF7_UART7
